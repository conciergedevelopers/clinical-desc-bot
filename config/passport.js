...
function initCloudant() {
    var cloudantURL = appEnv.services.cloudantNoSQLDB[0].credentials.url || appEnv.getServiceCreds("desc-cloudant").url;
...
// POLICY DEFAULTS =====================
// =====================================
function createRecords(account) {
    ...
    healthBenefits.records = [];
    healthBenefits.records.push(eyeWear);
    healthBenefits.records.push(eyeExam);
    healthBenefits.records.push(teethCleaning);
    healthBenefits.records.push(orthodontics);
    healthBenefits.records.push(teethRepair);
    healthBenefits.records.push(mentalHealth);
    healthBenefits.records.push(chiropractor);
    healthBenefits.records.push(physio);
